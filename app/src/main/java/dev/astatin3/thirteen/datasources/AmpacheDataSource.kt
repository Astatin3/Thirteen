...
import dev.astatin3.thirteen.datasources.ampache.AmpacheClient
...
class AmpacheDataSource(
    ...
    private class AmpacheInstance(
        ...
        fun dev.astatin3.thirteen.datasources.ampache.models.Album.toMediaItem() =
        ...
        fun dev.astatin3.thirteen.datasources.ampache.models.Artist.toMediaItem() =
        ...
        fun dev.astatin3.thirteen.datasources.ampache.models.Genre.toMediaItem() =
            Genre.Builder(getGenreUri(id))
                .setName(name)
                .build()

        fun dev.astatin3.thirteen.datasources.ampache.models.Lyrics.toModel() =
            Lyrics.Builder()
                .apply {
        ...
        fun dev.astatin3.thirteen.datasources.ampache.models.Playlist.toMediaItem() =
        ...
        fun dev.astatin3.thirteen.datasources.ampache.models.Song.toMediaItem() =
