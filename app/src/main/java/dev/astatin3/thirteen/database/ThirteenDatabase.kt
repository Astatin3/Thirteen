...
package dev.astatin3.thirteen.database
...
import dev.astatin3.thirteen.database.converters.InstantConverter
import dev.astatin3.thirteen.database.converters.UriConverter
import dev.astatin3.thirteen.database.dao.AmpacheProviderDao
import dev.astatin3.thirteen.database.dao.FavoriteDao
import dev.astatin3.thirteen.database.dao.JellyfinProviderDao
import dev.astatin3.thirteen.database.dao.MediaStatsDao
import dev.astatin3.thirteen.database.dao.PlaylistDao
import dev.astatin3.thirteen.database.dao.PlaylistItemCrossRefDao
import dev.astatin3.thirteen.database.dao.PlaylistWithItemsDao
import dev.astatin3.thirteen.database.dao.ResumptionPlaylistDao
import dev.astatin3.thirteen.database.dao.SubsonicProviderDao
import dev.astatin3.thirteen.database.entities.AmpacheProvider
import dev.astatin3.thirteen.database.entities.Favorite
import dev.astatin3.thirteen.database.entities.JellyfinProvider
import dev.astatin3.thirteen.database.entities.LocalMediaStats
import dev.astatin3.thirteen.database.entities.Playlist
import dev.astatin3.thirteen.database.entities.PlaylistItemCrossRef
import dev.astatin3.thirteen.database.entities.ResumptionItem
import dev.astatin3.thirteen.database.entities.ResumptionPlaylist
import dev.astatin3.thirteen.database.entities.SubsonicProvider
...
@Database(
    ...
    autoMigrations = [
        ...
        AutoMigration(from = 6, to = 7, spec = ThirteenDatabase.Companion.MigrationSpec6To7::class),
...
abstract class ThirteenDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        object Migration9To10 : Migration(9, 10) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    """
                        ALTER TABLE PlaylistItemCrossRef
