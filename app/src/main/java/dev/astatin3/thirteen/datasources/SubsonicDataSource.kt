...
package dev.astatin3.thirteen.datasources
...
import dev.astatin3.thirteen.datasources.subsonic.SubsonicClient
import dev.astatin3.thirteen.datasources.subsonic.models.AlbumID3
import dev.astatin3.thirteen.datasources.subsonic.models.ArtistID3
import dev.astatin3.thirteen.datasources.subsonic.models.Child
import dev.astatin3.thirteen.ext.isRelativeTo
import dev.astatin3.thirteen.models.ActivityTab
import dev.astatin3.thirteen.models.Album
import dev.astatin3.thirteen.models.Artist
import dev.astatin3.thirteen.models.ArtistWorks
import dev.astatin3.thirteen.models.Audio
import dev.astatin3.thirteen.models.DataSourceInformation
import dev.astatin3.thirteen.models.Error
import dev.astatin3.thirteen.models.Genre
import dev.astatin3.thirteen.models.GenreContent
import dev.astatin3.thirteen.models.LocalizedString
...
import dev.astatin3.thirteen.models.ProviderArgument
import dev.astatin3.thirteen.models.ProviderArgument.Companion.requireArgument
...
import dev.astatin3.thirteen.models.Result.Companion.flatMap
import dev.astatin3.thirteen.models.Result.Companion.getOrNull
...
class SubsonicDataSource(
    ...
    private class SubsonicInstance(
        ...
        fun dev.astatin3.thirteen.datasources.subsonic.models.Genre.toMediaItem() =
            Genre.Builder(getGenreUri(value))
                .setName(value)
                .build()

        fun dev.astatin3.thirteen.datasources.subsonic.models.Playlist.toMediaItem() =
            Playlist.Builder(getPlaylistUri(id))
                .setName(name)
                .build()

        fun dev.astatin3.thirteen.datasources.subsonic.models.MediaType?.toAudioType() = when (
            this
        ) {
            dev.astatin3.thirteen.datasources.subsonic.models.MediaType.MUSIC -> Audio.Type.MUSIC
            dev.astatin3.thirteen.datasources.subsonic.models.MediaType.PODCAST -> Audio.Type.PODCAST
            dev.astatin3.thirteen.datasources.subsonic.models.MediaType.AUDIOBOOK -> Audio.Type.AUDIOBOOK
            dev.astatin3.thirteen.datasources.subsonic.models.MediaType.VIDEO -> throw Exception(
        ...
        fun dev.astatin3.thirteen.datasources.subsonic.models.LyricsList.toModel() =
