...
import dev.astatin3.thirteen.datasources.jellyfin.JellyfinClient
import dev.astatin3.thirteen.datasources.jellyfin.models.Item
import dev.astatin3.thirteen.datasources.jellyfin.models.ItemType
...
class JellyfinDataSource(
    ...
    private class JellyfinInstance(
        ...
        fun dev.astatin3.thirteen.datasources.jellyfin.models.Lyrics.toModel() = lyrics?.let {
            Lyrics.Builder()
                .apply {
                    it.forEach { lyrics ->
                        addLine(
