...
package dev.astatin3.thirteen.services
...
import dev.astatin3.thirteen.MainActivity
import dev.astatin3.thirteen.R
import dev.astatin3.thirteen.ThirteenApplication
import dev.astatin3.thirteen.ext.Bundle
import dev.astatin3.thirteen.ext.enableFloatOutput
import dev.astatin3.thirteen.ext.enableOffload
import dev.astatin3.thirteen.ext.mapAsync
import dev.astatin3.thirteen.ext.mediaItems
import dev.astatin3.thirteen.ext.next
import dev.astatin3.thirteen.ext.setOffloadEnabled
import dev.astatin3.thirteen.ext.skipSilence
import dev.astatin3.thirteen.ext.stopPlaybackOnTaskRemoved
import dev.astatin3.thirteen.ext.typedRepeatMode
import dev.astatin3.thirteen.models.RepeatMode
import dev.astatin3.thirteen.ui.widgets.NowPlayingAppWidgetProvider
...
class PlaybackService : MediaLibraryService(), LifecycleOwner {
    ...
    private val resumptionPlaylistRepository by lazy {
        (application as ThirteenApplication).resumptionPlaylistRepository
    }

    private val mediaRepository by lazy {
        (application as ThirteenApplication).mediaRepository
    }

    private val providersRepository by lazy {
        (application as ThirteenApplication).providersRepository
    }

    private val outputConfigurationRepository by lazy {
        (application as ThirteenApplication).outputConfigurationRepository
    }
    ...
    companion object {
         ...
         */
        const val ACTION_TOGGLE_PLAY_PAUSE = "dev.astatin3.thirteen.ACTION_TOGGLE_PLAY_PAUSE"
    }
}
